...
from src.modules.actors.schemas import AdminProfileData, ConductorProfileData, MecanicoProfileData, ProfileOut, ProfileUpdate, TallerProfileData, UbicacionUpdate
...
@router.put("/me/ubicacion", response_model=ProfileOut)
