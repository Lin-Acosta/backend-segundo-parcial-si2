...
from src.modules.security.models import Rol, Usuario
from src.modules.actors.models import Mecanico, Taller
from src.modules.actors.schemas import MecanicoOut, MecanicoRegistro, MecanicoUpdate
...
@router.get("/", response_model=List[MecanicoOut])
...
@router.post("/", response_model=MecanicoOut, status_code=status.HTTP_201_CREATED)
...
@router.put("/{mecanico_id}", response_model=MecanicoOut)
