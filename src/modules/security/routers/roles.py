...
from src.modules.security.schemas import Permiso as PermisoSchema, Rol as RolSchema, RolCreate
...
@router.put("/{role_id}", response_model=RolSchema)
...
@router.get("/permisos/todos", response_model=List[PermisoSchema])
