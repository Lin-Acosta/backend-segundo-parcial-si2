...
from src.modules.actors.models import Administrador, Conductor, Taller
from src.modules.security.models import Rol, Usuario
from src.modules.security.schemas import Rol as RolSchema, Usuario as UsuarioSchema, UsuarioCreate, UsuarioUpdate
...
def get_roles(
    ...
    roles = db.query(Rol).all()  # ORM Rol model
    return roles
